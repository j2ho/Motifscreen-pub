...
ACLASS_ID = ['Null', #0: Unassigned
             ...
             #Hydrogens, attached to C,CR,O,N,S,or Generic 15~20
             'HC',
             'HR',
             'HO',
             'HN',
             ...
             'Nin',  #INdole(+iminium), 1-H 25
             'Nim',  #IMine (w/lone-pair), 0-H 
             'Ngu1', #GUanidium1, 1-H 27
             'Ngu2', #GUanidium1, 2-H 28
             'NG3',  #Generic_sp3 #non-acceptor/donor
             'NG2', #Generic_sp2, 0-H
             'NG21', #Generic_sp2, 1-H 31
             'NG22', #Generic_sp2, 2-H 32
             'NG1',  #Generic_sp1 #cyanide 33
             ...
             'Ofu', # FUran
             'Ont', # NiTro
             'OG2', # Generic_sp2, 0-H -- 41
             'OG3', # Generic_sp3, 0-H -- 42
             'OG31',# Generic_sp3, 1-H

             #Sulfur, Phosphorus 44~51
             'Sth', #THiol
             'Ssl', #SuLfide
             'SR',  #aromatic Sulfur
             'SG2', # Generic_sp2
...
CORRECT_HYBRID = [-1,
                  3, 3, 3, 3, 2, 2, 2, 2, 1, 3, 2, 2, 1, 3, #C: 1~14
                  -1, -1, -1, -1, -1, -1, #H
                  3, 3, 2, 2, 2, 2, 2, 2, 3, 2, 2, 2, 1, #N:21~33
                  3, 3, 2, 2, 2, 2, 2, 2, 3, 3,
                  3, 3, 2, 2, 3, 3, 3, 3,
                  -1, -1, -1, -1, -1, -1, -1, -1,
